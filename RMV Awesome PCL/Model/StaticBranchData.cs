    ...
    public class StaticBranchData
    {
        ...
        public static System.Collections.ObjectModel.ObservableCollection<Branch> Data
        {
            get
            {
                ...
                details.Add(new Branch() { Title = "Revere", Address = "9 Everett Street", Latitude = 42.409733, Longitude = -71.00108, Town = "Revere", ImagePath = "httpImagePathupload.wikimedia.org/wikipedia/commons/thumb/c/c5/Revere_City_Hall.JPG/320px-Revere_City_Hall.JPG" });
                ...
                details.Add(new Branch() { Title = "Worcester", Address = "611 Main Street", Latitude = 42.260149, Longitude = -71.804329, Town = "Worcester", ImagePath = "http://upload.wikimedia.org/wikipedia/commons/thumb/9/90/Downtown_Worcester%2C_Massachusetts" });
