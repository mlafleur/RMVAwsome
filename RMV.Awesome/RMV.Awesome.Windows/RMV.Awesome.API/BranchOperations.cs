...
{
    internal partial class BranchOperations : IServiceOperations<RMVAwesomeAPIClient>, IBranchOperations
    {
        /// <summary>
        ...
        /// </param>
        internal BranchOperations(RMVAwesomeAPIClient client)
        {
            this._client = client;
        }
        
        private RMVAwesomeAPIClient _client;
        
        /// <summary>
        /// Gets a reference to the RMV.Awesome.Api.RMV.Awesome.APIClient.
        /// </summary>
        public RMVAwesomeAPIClient Client
        {
