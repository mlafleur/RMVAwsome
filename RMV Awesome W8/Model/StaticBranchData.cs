    ...
    public class StaticBranchData
    {
        ...
        public static System.Collections.ObjectModel.ObservableCollection<Branch> Data
        {
            get
            {
                ...
                details.Add(new Branch() { Title = "Greenfield", Address = "18 Miner Street", Latitude = 42.588123, Longitude = -72.601311, Town = "Greenfield", ImagePath = "http://upload.wikimedia.org/wikipedia/commons/thumb/e/ed/Greenfield_Town_Hall.jpg/411px-Greenfield_Town_Hall.jpg" });
                ...
                details.Add(new Branch() { Title = "Revere", Address = "9 Everett Street", Latitude = 42.409733, Longitude = -71.00108, Town = "Revere", ImagePath = "http://upload.wikimedia.org/wikipedia/commons/thumb/c/c5/Revere_City_Hall.JPG/320px-Revere_City_Hall.JPG" });
                ...
                details.Add(new Branch() { Title = "Worcester", Address = "611 Main Street", Latitude = 42.260149, Longitude = -71.804329, Town = "Worcester", ImagePath = "http://upload.wikimedia.org/wikipedia/commons/thumb/9/90/Downtown_Worcester%2C_Massachusetts.jpg/320px-Downtown_Worcester%2C_Massachusetts.jpg" });
                return details;
            }
        }
    }        
