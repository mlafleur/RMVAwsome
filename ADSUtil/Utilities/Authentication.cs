...
namespace ADSUtil.Utilities
{
    ...
    public class Authentication
    {
        public static async Task<bool> AuthenticateAsync(MobileServiceAuthenticationProvider provider)
        {
            ...
            // Test against second service
            MobileServiceClient MobileService = new MobileServiceClient("https://rmvawesomemobileservice-w8.azure-mobile.net/", "fFfHlEQeHlwMrPEahDdaXmIpdQnbtK50");
            MobileService.CurrentUser = App.RMVAwesomeMobileServiceClient.CurrentUser;
            await MobileService.GetTable("TestTable").ReadAsync(string.Empty);
